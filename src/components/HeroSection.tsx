    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-visible pt-8">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-extrabold mb-6 leading-[1.15] overflow-visible"
        >
          Simula una
          <span className="block text-gradient-primary py-1">giornata di lavoro</span>
          nel digitale
        </motion.h1>
